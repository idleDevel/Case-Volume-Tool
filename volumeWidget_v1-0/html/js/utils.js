...
function lock(event) {
    ...
    var lengthModifier = document.getElementById("lengthModifier");
    var lengthButton = document.getElementById("commitLength");
    

    var width = document.getElementById("width");
    var widthModifier = document.getElementById("widthModifier");
    var widthButton = document.getElementById("commitWidth");
    

    var height = document.getElementById("height");
    var heightModifier = document.getElementById("heightModifier");
    var heightButton = document.getElementById("commitHeight");
